...
export default function Footer() {
  return (
    <footer className="w-full bg-[#ffffff] border-t border-[#e5e5e5] mt-auto">
      <div className="flex flex-col md:flex-row justify-between items-center px-5 md:px-16 py-12 w-full max-w-7xl mx-auto gap-8">
        <span className="font-serif text-3xl md:text-2xl font-bold tracking-widest text-black uppercase">THRIFTX</span>
